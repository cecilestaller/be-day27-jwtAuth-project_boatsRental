// !! Wird nicht mehr benötitgt dank authorization mit Tokens (doJwtAuth)
...
//   req.authenticatedUser = foundUser; // save user into request, for next request-handler/controller
//   next();
// }
