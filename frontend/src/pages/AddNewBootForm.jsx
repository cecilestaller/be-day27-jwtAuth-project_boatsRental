...
const AddNewBootForm = ({ authorization, userProfileInfo }) => {
    ...
    fetch(`${backendUrl}/api/files/upload`, {
      ...
      .then((uploadedFilename) =>
        fetch(`${backendUrl}/api/boote`, {
          ...
          headers: { "Content-Type": "application/json", authorization }, // Include authorization string in header authorization field !!!
        })
      )
      .then((res) => res.json())
      .then(({ success, result, error, message }) => {
  ...
  return (
    <>
      ...
      <section className="content-wrapper">
        <form>
          <h2>{`Hallo ${userProfileInfo.name}, füge ein neues Boot hinzu`}</h2>
          <div>
            <input
              type="text"
